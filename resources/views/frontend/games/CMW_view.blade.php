...
@include('frontend.layouts.nav_cmw')
<section class=" cmw_1BG top_page text-center">
    <div class="row" >
        <div class='col-lg-6 col-md-6 col-sm-12'>
            <div class='cmw_headfont'>CALL OF DUTY MODERN WARFARE</div>
            <div class='cmw_subheadfont'>CLICK ON A SERVICE TO START</div>
        </div>
    </div>
    <div>&ensp;</div>
    <div class = "row col-lg-6 justify-content-center">
         @forelse($products as $product)
             <div class='col-lg-6 col-md-6' style="padding:10px 0px">
                 <button type="button" class="btn btn-cmw1" ><a href="{{ url('games/'.$game->game_link.'/'.$product->product_link) }}" style="text-transform: uppercase">{{ $product->name }}</a></button>&ensp;&ensp;<img  src='{{ asset('frontend/images/games/cmw/arrow.png') }}' width='13%'>
             </div>
             @empty
...
<section>
    <div class=' text-center cmw_2BG'>
        <div class=" mt-1.5 cmw_2image_font">WHAT OUR CUSTOMERS SAID ABOUT US</div>
        <div class="reviews">
            <div class="mt-1.5 text-center">
                <a href="https://www.trustpilot.com/review/boostingplus.com" target="_blank" rel="noopener"><img src='{{ asset('frontend/images/games/cmw/review.png') }}'></a>
             </div>
             <div>
                 <img style='padding:15px' src='{{asset('frontend/images/games/cmw/review1.png') }}'>
                 <img style='padding:15px' src='{{asset('frontend/images/games/cmw/review2.png') }}'>
                 <img style='padding:15px' src='{{asset('frontend/images/games/cmw/review3.png') }}'>
             </div>
        </div>
    </div>
</section>
<section class ='cmw_3BG'  >
    <div class='row justify-content-center' >
        ...
        <div class='row mt-5  justify-content-center'>
            <div class="cont col-lg-4 col-md-4 text-center">
                ...
                <img class="mb-5  image" style='border-radius: 5%' src='{{asset('frontend/images/games/cmw/order.png') }}'>
                <div class="overlay_cmw">
            ...
            <div  class="col-lg-4 col-md-4 text-center">
                <img class="mt-3 " src='{{asset('frontend/images/games/cmw/logo.png')}}' width='70%'>
            </div>
            <div class="cont col-lg-4 col-md-4 text-center">
                <div class="my-3 cmw_order_font">2) LIVE TRACK YOUR ORDER PAGE</div>
                <img class="mb-5 image" style='border-radius: 5%' src='{{asset('frontend/images/games/cmw/chat.png') }}'>
                <div class="overlay_cmw">
                    <a href="#" class="icon" title="User Profile">
...
<section class="cmw_4BG text-center" style='padding:0px 10%'>
        <div>&ensp;</div>
        <div class=" cmw_blog_main_font">BLOG & GUIDE</div>
        <div class=' row mt-5  justify-content-center'>
            <div class='mt-3 col-lg-4 col-md-4 text-center'>
                <img src='{{asset('frontend/images/games/cmw/blog1.png') }}' width='70%'>
            </div>
            <div class='mt-3 col-lg-4 col-md-4 text-center'>
                <img  src='{{asset('frontend/images/games/cmw/blog2.png') }}' width='70%'>
            </div>
            <div class='my-3 col-lg-4 col-md-4 text-center'>
                <img  src='{{asset('frontend/images/games/cmw/blog3.png') }}' width='70%'>
            </div>
        </div>
        <button type="button" class="btn btn-cmw2" ><a href="#">EXPLORE THE BLOG</a></button>
   <div>&ensp;</div>
   <div>&ensp;</div>
</section>
<section class='cmw_5BG text-center'>
    <div>&ensp;</div>
    <div class="faq_section">
        <div class="container-fluid container-fluid_add">
        <div class="faq-main">
          <div class="faq-inner">
            <h1>Call of Duty Modern Warfare boosting FAQ</h1>
          </div><!--faq-inner--end-->
          <div id="accordion">
            <div class="card">
              <div class="card-header" id="headingOne">
                <h5 class="mb-0">
                  <button class="btn btn-link collapsed " data-toggle="collapse" data-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                    How does CoD Modern Warfare boosting work?
                  </button>
                </h5>
              </div>
              ...
              <div class="card-header" id="headingTwo">
                <h5 class="mb-0">
                  <button class="btn btn-link collapsed" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
                    How much does cmw boosting cost?
                  </button>
                </h5>
              </div>
        ...
        <button type="button" class=" btn btn-cmw2" ><a href="#">LOAD MORE</a></button>
        <div>&ensp;</div>
        <div>&ensp;</div>
</section >
