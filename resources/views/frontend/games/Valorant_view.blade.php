...
@include('frontend.layouts.nav_val')
<section class=" valorant_1BG top_page text-center">
    <div class="row" >
        <div class='col-lg-6 col-md-6 col-sm-12'>
            <div class='valorant_headfont'>VALORANT BOOSTING</div>
            <div class='valorant_subheadfont'>CLICK ON A SERVICE TO START</div>
        </div>
    </div>
    <div>&ensp;</div>
    <div class = "row col-lg-6 justify-content-center">
         @forelse($products as $product)
             <div class='col-lg-6 col-md-6' style="padding:10px 0px">
                 <button type="button" class="btn btn-val1" ><a href="{{ url('games/'.$game->game_link.'/'.$product->product_link) }}" style="text-transform: uppercase">{{ $product->name }}</a></button>
             </div>
             @empty
...
<section>
    <div class=' text-center valorant_2BG'>
        <div class=" mt-1.5 valorant_2image_font">WIDTH OUR CUSTOMERS SAID ABOUT US</div>
        <div class="reviews">
            <div class="mt-1.5 text-center">
                <a href="https://www.trustpilot.com/review/boostingplus.com" target="_blank" rel="noopener"><img src='{{ asset('frontend/images/games/valorant/review.png') }}'></a>
             </div>
             <div>
                 <img style='padding:15px' src='{{asset('frontend/images/games/valorant/review1.png') }}'>
                 <img style='padding:15px' src='{{asset('frontend/images/games/valorant/review2.png') }}'>
                 <img style='padding:15px' src='{{asset('frontend/images/games/valorant/review3.png') }}'>
             </div>
        </div>
    </div>
</section>
<section class ='valorant_3BG'  >
    <div class='row justify-content-center' >
        <div class=" mt-4 col-12 valorant_main_font">ODERING & TRACKING MADE EASY</div>
        <div class='row mt-5  justify-content-center'>
            <div class="cont col-lg-4 col-md-4 text-center">
                <div class="my-3 valorant_order_font">1) FILL IN THE ORDER FORM & PAGE</div>
                <img class="mb-5  image" style='border-radius: 5%' src='{{asset('frontend/images/games/valorant/order.png') }}'>
                <div class="overlay_valorant">
            ...
            <div  class="col-lg-4 col-md-4 text-center">
                <img class="mt-3 " src='{{asset('frontend/images/games/valorant/logo.png')}}' width='70%'>
            </div>
            <div class="cont col-lg-4 col-md-4 text-center">
                <div class="my-3 valorant_order_font">2) LIVE TRACK YOUR ORDER PAGE</div>
                <img class="mb-5 image" style='border-radius: 5%' src='{{asset('frontend/images/games/valorant/chat.png') }}'>
                <div class="overlay_valorant">
                    <a href="#" class="icon" title="User Profile">
...
<section class="valorant_4BG text-center" style='padding:0px 10%'>
        <div>&ensp;</div>
        <div class=" valorant_blog_main_font">BLOG & GUIDE</div>
        <div class=' row mt-5  justify-content-center'>
            <div class='mt-3 col-lg-4 col-md-4 text-center'>
                <img src='{{asset('frontend/images/games/valorant/blog1.png') }}' width='70%'>
            </div>
            <div class='mt-3 col-lg-4 col-md-4 text-center'>
                <img  src='{{asset('frontend/images/games/valorant/blog2.png') }}' width='70%'>
            </div>
            <div class='my-3 col-lg-4 col-md-4 text-center'>
                <img  src='{{asset('frontend/images/games/valorant/blog3.png') }}' width='70%'>
            </div>
        </div>
        <button type="button" class="btn btn-val2" ><a href="#">EXPLORE THE BLOG</a></button>
   <div>&ensp;</div>
   <div>&ensp;</div>
</section>
<section class='valorant_5BG text-center'>
    <div>&ensp;</div>
    <div class="faq_section">
        <div class="container-fluid container-fluid_add">
        <div class="faq-main">
          <div class="faq-inner">
            <h1>Valorant Boosting FAQ</h1>
          </div><!--faq-inner--end-->
          <div id="accordion">
            <div class="card">
        ...
        <button type="button" class=" btn btn-val2" ><a href="#">LOAD MORE</a></button>
        <div>&ensp;</div>
        <div>&ensp;</div>
</section >
