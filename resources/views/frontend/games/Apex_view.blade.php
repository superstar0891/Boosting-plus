...
@include('frontend.layouts.nav_apex')
<section class=" apex_1BG top_page text-center">
    <div class="row" >
        <div class='col-lg-6 col-md-6 col-sm-12'>
            <div class='apex_headfont'>APEX LEGENDS BOOSTING</div>
            <div class='apex_subheadfont'>CLICK ON A SERVICE TO START</div>
        </div>
    </div>
    <div>&ensp;</div>
    <div class = "row col-lg-6 justify-content-center">
         @forelse($products as $product)
             <div class='col-lg-6 col-md-6' style="padding:10px 0px">
                 <button type="button" class="btn btn-apex" ><a href="{{ url('games/'.$game->game_link.'/'.$product->product_link) }}" style="text-transform: uppercase">{{ $product->name }}</a></button>
             </div>
             @empty
...
<section>
    <div class=' text-center apex_2BG'>
        <div class=" mt-1.5 apex_2image_font">WHAT OUR CUSTOMERS SAID ABOUT US</div>
        <div class="reviews">
            <div class="mt-1.5 text-center">
                <a href="https://www.trustpilot.com/review/boostingplus.com" target="_blank" rel="noopener"><img src='{{ asset('frontend/images/games/apex/review.png') }}'></a>
             </div>
             <div>
                 <img style='padding:15px' src='{{asset('frontend/images/games/apex/review1.png') }}'>
                 <img style='padding:15px' src='{{asset('frontend/images/games/apex/review2.png') }}'>
                 <img style='padding:15px' src='{{asset('frontend/images/games/apex/review3.png') }}'>
             </div>
        </div>
    </div>
</section>
<section class ='apex_3BG'  >
    <div class='row justify-content-center' >
        <div class=" mt-4 col-12 apex_main_font">ODERING & TRACKING MADE EASY</div>
        <div class='row mt-5  justify-content-center'>
            <div class="cont col-lg-4 col-md-4 text-center">
                <div class="my-3 apex_order_font">1) FILL IN THE ORDER FORM & PAGE</div>
                <img class="mb-5  image" style='border-radius: 5%' src='{{asset('frontend/images/games/apex/order.png') }}'>
                <div class="overlay_apex">
            ...
            <div  class="col-lg-4 col-md-4 text-center">
                <img class="mt-3 " src='{{asset('frontend/images/games/apex/logo.png')}}' width='70%'>
            </div>
            <div class="cont col-lg-4 col-md-4 text-center">
                <div class="my-3 apex_order_font">2) LIVE TRACK YOUR ORDER PAGE</div>
                <img class="mb-5 image" style='border-radius: 5%' src='{{asset('frontend/images/games/apex/chat.png') }}'>
                <div class="overlay_apex">
                    <a href="#" class="icon" title="User Profile">
...
<section class="apex_4BG text-center" style='padding:0px 10%'>
        <div>&ensp;</div>
        <div class=" apex_blog_main_font">BLOG & GUIDE</div>
        <div class=' row mt-5  justify-content-center'>
            <div class='mt-3 col-lg-4 col-md-4 text-center'>
                <img src='{{asset('frontend/images/games/apex/blog1.png') }}' width='70%'>
            </div>
            <div class='mt-3 col-lg-4 col-md-4 text-center'>
                <img  src='{{asset('frontend/images/games/apex/blog2.png') }}' width='70%'>
            </div>
            <div class='my-3 col-lg-4 col-md-4 text-center'>
                <img  src='{{asset('frontend/images/games/apex/blog3.png') }}' width='70%'>
            </div>
        </div>
        <button type="button" class="btn btn-prim" ><a href="#">EXPLORE THE BLOG</a></button>
   <div>&ensp;</div>
   <div>&ensp;</div>
</section>
<section class='apex_5BG text-center'>
    <div>&ensp;</div>
    <div class="faq_section">
        <div class="container-fluid container-fluid_add">
        <div class="faq-main">
          <div class="faq-inner">
            <h1>apex Boosting FAQ</h1>
          </div><!--faq-inner--end-->
          <div id="accordion">
            <div class="card">
              <div class="card-header" id="headingOne">
                <h5 class="mb-0">
                  <button class="btn btn-link collapsed " data-toggle="collapse" data-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                    How does Apex Legends boosting work?
                  </button>
                </h5>
              </div>
              ...
              <div class="card-header" id="headingTwo">
                <h5 class="mb-0">
                  <button class="btn btn-link collapsed" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
                    How much does Apex Legends boosting cost?
                  </button>
                </h5>
              </div>
              ...
              <div class="card-header" id="headingsix">
                <h5 class="mb-0">
                  <button class="btn btn-link collapsed" data-toggle="collapse" data-target="#collapsesix" aria-expanded="false" aria-controls="collapsesix">
                    Can I choose which legends a booster will play on my account?
                  </button>
                </h5>
              </div>
        ...
        <button type="button" class=" btn btn-prim" ><a href="#">LOAD MORE</a></button>
        <div>&ensp;</div>
        <div>&ensp;</div>
</section >
