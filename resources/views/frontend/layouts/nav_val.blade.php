...
<div class="navigation-section">
  <div class="container-fluid">
    <div class="nav-inner">
      <nav class="navbar navbar-expand-lg navbar-light fixed-top " style='background: #1b1b1b'>
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
          <ul class="navbar-nav">
            ...
            <li class="nav-item dropdown">
              ...
              <div class="dropdown-menu" style='background: #1b1b1b' aria-labelledby="navbarDropdown">
