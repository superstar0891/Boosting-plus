...
<div class="navigation-section">
  <div class="container-fluid">
    <div class="nav-inner">
      <nav class="navbar navbar-expand-lg navbar-light fixed-top " style='background: #010e1f'>
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
          <ul class="navbar-nav">
            ...
            <li class="nav-item dropdown">
              ...
              <div class="dropdown-menu" style='background: #010e1f' aria-labelledby="navbarDropdown">
